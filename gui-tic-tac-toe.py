...
root.geometry("554x636")
root.resizable(0, 0)
turn, opp = "X", "O"
turn_label = Label(root, text = f"Turn:  {turn}", font = ('Times 26 bold'))
turn_label.place(x = 277, y = 25, anchor = "center")
button1 = Button(root, text = " ", height = 4, width = 8, bd = 5, font = ('Times 26 bold'), command = button1_func)
button1.place(x = 0, y = 50)
button2 = Button(root, text = " ", height = 4, width = 8, bd = 5, font = ('Times 26 bold'), command = button2_func)
button2.place(x = 185, y = 50)
button3 = Button(root, text = " ", height = 4, width = 8, bd = 5, font = ('Times 26 bold'), command = button3_func)
button3.place(x = 370, y = 50)
button4 = Button(root, text = " ", height = 4, width = 8, bd = 5, font = ('Times 26 bold'), command = button4_func)
button4.place(x = 0, y = 245)
button5 = Button(root, text = " ", height = 4, width = 8, bd = 5, font = ('Times 26 bold'), command = button5_func)
button5.place(x = 185, y = 245)
button6 = Button(root, text = " ", height = 4, width = 8, bd = 5, font = ('Times 26 bold'), command = button6_func)
button6.place(x = 370, y = 245)
button7 = Button(root, text = " ", height = 4, width = 8, bd = 5, font = ('Times 26 bold'), command = button7_func)
button7.place(x = 0, y = 440)
button8 = Button(root, text = " ", height = 4, width = 8, bd = 5, font = ('Times 26 bold'), command = button8_func)
button8.place(x = 185, y = 440)
button9 = Button(root, text = " ", height = 4, width = 8, bd = 5, font = ('Times 26 bold'), command = button9_func)
button9.place(x = 370, y = 440)
root.mainloop()
